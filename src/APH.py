...
def parser_args():
    ...
    parser.add_argument('-data', "--dataset_name", required=True, default='Cifar10_NonIID_dir_0.1_Client_10', type=str)
    ...
    parser.add_argument('-mn', "--model_name", default='FedAvg_gr_100_ls_10_jr_1.0_CNN_FedAvg_NonIID_NonBalance_jr_1.0_dir_0.1_best.pt', required=True, type=str)
...
if __name__ == '__main__':
    ...
    save_file_path = f'APH_{algo}_{dataset_name}_Epoch_{global_epoch}_HeadsNum_{sampling_num}_ulr_{args.upper_lr}_llr_{args.lower_lr}_seed_{args.seed}_lamda_{lamda}.pkl'
